...
template void igl::AABB<Eigen::Matrix<mpfr::mpreal, -1, -1, 0, -1, -1>, 2>::init(Eigen::PlainObjectBase<Eigen::Matrix<mpfr::mpreal, -1, -1, 0, -1, -1> > const&, Eigen::Matrix<int, -1, -1, 0, -1, -1> const&);
template std::__1::vector<int, std::__1::allocator<int> > igl::AABB<Eigen::Matrix<mpfr::mpreal, -1, -1, 0, -1, -1>, 2>::find<Eigen::Matrix<mpfr::mpreal, 1, -1, 1, 1, -1> >(Eigen::PlainObjectBase<Eigen::Matrix<mpfr::mpreal, -1, -1, 0, -1, -1> > const&, Eigen::Matrix<int, -1, -1, 0, -1, -1> const&, Eigen::PlainObjectBase<Eigen::Matrix<mpfr::mpreal, 1, -1, 1, 1, -1> > const&, bool) const;
#endif
